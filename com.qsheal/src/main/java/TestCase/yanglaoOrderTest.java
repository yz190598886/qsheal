...
public class yanglaoOrderTest {
    public String name(){
        ...
        public void adduser() throws Exception {
            ...
            ZFHttp.postMethod(addUserurl,ZFcookie);//添加老人
            ...
            ZFHttp.postMethod(charge,ZFcookie);//充分
            ...
            QYHttp.postMethod(Orderurl,QYcookie);//创建订单
            ...
            QYHttp.postMethod(paidanurl,QYcookie);//派工
            ...
            AppHttp.postMethod(startServiceurl,Appcookie);//开始服务，上传坐标
            ...
            AppHttp.postMethod(completeServiceUrl,Appcookie);
            ...
            AppHttp.postMethod(updateServiceDegreeUrl,Appcookie);
