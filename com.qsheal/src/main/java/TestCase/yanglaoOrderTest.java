...
public class yanglaoOrderTest {
        ...
        public  String uid() throws SQLException {
        jdbc jdbc=new jdbc();
        String uid=jdbc.getuid(idcard());
        return uid;
        ...
        public void adduser() throws IOException, SQLException {
            ...
            String addUserurl="https://test.chinaylzl.com/surveyUser/addSurveyUser?" +
                    "id=&uid=&buyYwshbxZiji=&buyYwshbxZinv=&buyYwshbxDanwei=&buyYwshbxZengyu=&buyYwshbxQita=&sourceType=&currentStatus=1&headImage=&idcard="+idcard()+"&username="+name()+"&nationality=%E6%B1%89%E6%97%8F&maritalstatus=0" +
            ...
            String yue="https://test.chinaylzl.com/surveyUser/userListFinance?uid="+uid()+"&_=1516695813599?uid=781241&_=1516695813599";
